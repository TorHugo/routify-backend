...
import com.dev.app.routify.infrastructure.event.template.CustomerPermissionsEventTemplate
...
class DomainEventProducerImpl(
    ...
    private val customerPermissionsEventTemplate: CustomerPermissionsEventTemplate
) : DomainEventProducer {
    ...
    override fun publish(domainEventType: DomainEventTypeEnum, message: DomainEvent): Boolean {
        ...
        val isPublished = when (domainEventType) {
            ...
            DomainEventTypeEnum.CUSTOMER_PERMISSIONS_EVENT ->
                customerPermissionsEventTemplate.publishMessage(message = message)
        }
